//------------------------------------------------------------------------------
// <copyright file="ProjectWithTestCommand.cs" company="Company">
...
namespace Xcentium.HelixExtension
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ProjectWithTestCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectWithTestCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private ProjectWithTestCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static ProjectWithTestCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new ProjectWithTestCommand(package);
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    CommandHelper.AddTestProject(selectedItem, layerName, solutionName);
                }
            }
            catch
            {
